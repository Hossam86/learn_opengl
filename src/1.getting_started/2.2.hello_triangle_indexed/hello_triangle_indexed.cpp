...
void generate_indexed_triangles(float **vertices, int *n_verts, int **indices,
                                int *n_indices);

void copy_vertices_to_gpu(float **vertices, int n_verts, int **indices,
                          int n_indices, GLuint &VBO, GLuint &VAO, GLuint &EBO);
...
void copy_vertices_to_gpu(float **vertices, int n_verts, int **indices,
                          int n_indices, GLuint &VBO, GLuint &VAO,
                          GLuint &EBO) {
  ...
  glBufferData(GL_ARRAY_BUFFER, n_verts * sizeof(float), *vertices,
               GL_STATIC_DRAW);

  // 3. copy our index array in a element buffer for OpenGL to use
  glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO);
  glBufferData(GL_ELEMENT_ARRAY_BUFFER, n_indices * sizeof(int), *indices,
               GL_STATIC_DRAW);
