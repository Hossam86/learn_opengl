...
// callback function on the window that gets called each time the window is
// resized.
void framebuffer_size_callback(GLFWwindow *window, int width, int height) {
  // glfw: whenever the window size changed (by OS or user resize) this callback
  // function executes width and height will be significantly larger than
...
// this with several of GLFW's input
//  functions. We'll be using GLFW's glfwGetKey function that takes the window
//  as input together with a key. The function returns whether this key is
//  currently being pressed. We're creating a processInput function
